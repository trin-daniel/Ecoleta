...
const Detail: React.FC = () =>{
  ...
  function handleComposeMail(){
    MailComposer.composeAsync({
      subject: 'Interesse em despejar resíduos no ambiente coleta',
      recipients: [data.point.email]
    })
  }
  function handleWhatsapp(){
    Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=Interesse em despejar resíduos no ambiente coleta.`)
  }
